...
9. Memory path is fixed to `/Users/jiangxianjie/.codex/automations/flaky-reporter/memory.md`.
10. Memory is run history only. It must not influence snippet selection.
